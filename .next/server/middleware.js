...
;// CONCATENATED MODULE: ./node_modules/jose/dist/webapi/lib/signing.js
...
;// CONCATENATED MODULE: ./node_modules/jose/dist/webapi/lib/helpers.js
...
;// CONCATENATED MODULE: ./node_modules/jose/dist/webapi/lib/type_checks.js
const isObjectLike = (value)=>typeof value === "object" && value !== null;
function type_checks_isObject(input) {
...
const isJWK = (key)=>type_checks_isObject(key) && typeof key.kty === "string";
...
async function flattenedVerify(jws, key, options) {
    ...
    if (jws.header !== undefined && !type_checks_isObject(jws.header)) {
    ...
    const data = concat(jws.protected !== undefined ? encode(jws.protected) : new Uint8Array(), encode("."), typeof jws.payload === "string" ? b64 ? encode(jws.payload) : buffer_utils_encoder.encode(jws.payload) : jws.payload);
...
function validateClaimsSet(protectedHeader, encodedPayload, options = {}) {
    ...
    if (!type_checks_isObject(payload)) {
