    ...
    <>
      <style jsx global>{`
        *{margin:0;padding:0;box-sizing:border-box;}
        ...
        .mercury{
            width:22px;height:22px;top:-11px;left:50%;transform:translateX(-50%);
            background:#8C7853;box-shadow:0 0 20px rgba(255,255,255,0.7);
        }
        ...
        .venus{
            ...
            background:#E6C588;box-shadow:0 0 25px rgba(255,179,71,0.8);
        }
        ...
        .mars{
            ...
            background:#C1440E;box-shadow:0 0 25px rgba(209,74,40,0.8);
        }

        /* المشتري */
        .orbit4{width:740px;height:740px;animation:spin 35s linear infinite;}
        .jupiter{
            width:85px;height:85px;top:-42px;left:50%;transform:translateX(-50%);
            background:linear-gradient(180deg,#D8CA9D,#A67C52,#D8CA9D);
        ...
        .saturn{
            ...
            background:#EAD6A9;box-shadow:0 0 40px rgba(231,194,127,0.9);
        }
        .saturn::after{
            content:'';position:absolute;width:130px;height:32px;
            border:3px solid rgba(255,220,150,0.8);border-radius:50%;
        ...
        .moon{
            width:22px;height:22px;top:-11px;left:50%;transform:translateX(-50%);
            background:#C0C0C0;box-shadow:0 0 20px rgba(255,255,255,0.6);
        }

        /* اورانوس */
        .orbit7{width:980px;height:980px;animation:spin 65s linear infinite;}
        .uranus{
            width:55px;height:55px;top:-27px;left:50%;transform:translateX(-50%);
            background:#4FD1C5;box-shadow:0 0 30px rgba(79,209,197,0.8);
        }
        ...
        .neptune{
            width:55px;height:55px;top:-27px;left:50%;transform:translateX(-50%);
            background:#2B6CB0;box-shadow:0 0 30px rgba(43,108,176,0.8);
        }
