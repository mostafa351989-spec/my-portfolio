...
export default function AdminProjects() {
  ...
  const addProject = async (e) => { e.preventDefault(); await fetch('/api/projects', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ title, category: 'design', tags: [], link: '#' }) }); setTitle(''); fetchProjects(); };
